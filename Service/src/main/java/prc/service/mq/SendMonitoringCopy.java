...
@Service
@Slf4j
public class SendMonitoringCopy implements RabbitTemplate.ConfirmCallback, RabbitTemplate.ReturnCallback {
    @Autowired
    ...
    public void send(IUPayment payment) {
        ...
        rabbitTemplate.convertAndSend(RabbitConfig.COPY_MONITORING_EXCHANGE, RabbitConfig.COPY_MONITORING_ROUTING, JSON.toJSONString(payment));
    }
